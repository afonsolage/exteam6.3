...
{
	SMDFile = fopen("..\\Data\\ExData\\Events\\MossMerchant.ini", "r");

	if ( SMDFile == NULL )
	{
		MessageBoxA(0,"[MossMerchant] Info file Load Fail [..\\Data\\ExData\\Events\\MossMerchant.ini]","CRITICAL ERROR",0);
		ExitProcess(1);
		return;
	}

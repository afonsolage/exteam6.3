...
//Season 5 DoppelGanger
BOOL CItemBagEx::DropGoldenChestItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
//Season 5 New Box
//BOOL CItemBagEx::DropShiningJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	if ( this->m_bLoad == FALSE ) return FALSE;
//	float fDur = 0;
//	int iType = 0;
//	int iLevel = 0;
//	int X = 0;
...
//		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, X, Y, iType, iLevel, fDur,
//			iOption1, iOption2, iOption3, lpObj->m_Index, iExOption, 0);
//		LogAddTD("[ Shining Jewelry Case ] Drop [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
//			lpObj->AccountID, lpObj->Name, btMapNumber, X, Y, ItemAttribute[iType].Name,
//			iType, iLevel, iOption1, iOption2, iOption3, iExOption);
//		return TRUE;
//	}
//	return TRUE;
//}
//BOOL CItemBagEx::DropElegantJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	if ( this->m_bLoad == FALSE ) return FALSE;
//	float fDur = 0;
//	int iType = 0;
...
//		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, X, Y, iType, iLevel, fDur,
//			iOption1, iOption2, iOption3, lpObj->m_Index, iExOption, 0);
//		LogAddTD("[ Elegant Jewelry Case ] Drop [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
//			lpObj->AccountID, lpObj->Name, btMapNumber, X, Y, ItemAttribute[iType].Name,
//			iType, iLevel, iOption1, iOption2, iOption3, iExOption);
//		return TRUE;
//	}
//	return TRUE;
//}
//BOOL CItemBagEx::DropSteelJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	if ( this->m_bLoad == FALSE ) return FALSE;
//	float fDur = 0;
//	int iType = 0;
...
//		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, X, Y, iType, iLevel, fDur,
//			iOption1, iOption2, iOption3, lpObj->m_Index, iExOption, 0);
//		LogAddTD("[ Steel Jewelry Case ] Drop [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
//			lpObj->AccountID, lpObj->Name, btMapNumber, X, Y, ItemAttribute[iType].Name,
//			iType, iLevel, iOption1, iOption2, iOption3, iExOption);
//		return TRUE;
//	}
//	return TRUE;
//}
//BOOL CItemBagEx::DropOldJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	if ( this->m_bLoad == FALSE ) return FALSE;
//	float fDur = 0;
//	int iType = 0;
...
//		ItemSerialCreateSend(lpObj->m_Index, btMapNumber, X, Y, iType, iLevel, fDur,
//			iOption1, iOption2, iOption3, lpObj->m_Index, iExOption, 0);
//		LogAddTD("[ Old Jewelry Case ] Drop [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
//			lpObj->AccountID, lpObj->Name, btMapNumber, X, Y, ItemAttribute[iType].Name,
//			iType, iLevel, iOption1, iOption2, iOption3, iExOption);
//		return TRUE;
//	}

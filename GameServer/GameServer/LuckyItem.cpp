...
#ifdef DEBUG_CODE
	LogAddC(3,"SetOption: %d",SetOption);
	//ItemSerialCreateSend(lpObj->m_Index, 0xFF, 0, 0, Type, level, dur, Op1, Op2, Op3, lpObj->m_Index, ExOption, 5);
#endif
...
int LuckyItemManager::GDReqLuckyItemInsert(CItem * pItem, int iObjIndex)	//OK
{
	...
	long dwSerial			= pItem->m_Number;//m_serial;	//ebp-0c
	WORD wDurabilitySmall	= pItem->m_DurabilitySmall;	//ebp-10

#ifdef DEBUG_CODE
	LogAddC(1,"dwSerial: %d",dwSerial);
#endif
	// ----

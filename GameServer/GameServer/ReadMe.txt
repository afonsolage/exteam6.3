...
\common\WzMemScript.cpp				:: 100% ::
	...
	//int PointNext =5;//To Continue
	//this->LoadSkill(eSkill1,  "Damage",				100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill2,  "Free Points",		100,	100,PointNext,	false);
	//this->LoadSkill(eSkill3,  "Summon Pet",			100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill4,  "Wings Damage Plus",	100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill5,  "Final Mana",			1,		10,	PointNext,	false);
	//this->LoadSkill(eSkill6,  "Ignore Defence",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill7,  "Reset Level",		1,		20,	PointNext,	false);
	//this->LoadSkill(eSkill8,  "Teleport",			1,		1,	PointNext,	false);
	//this->LoadSkill(eSkill9,  "Critical Damage Rate",1,		10,	PointNext,	true);
	//this->LoadSkill(eSkill10, "Absord Damage",		1,		5,	PointNext,	true);
	//this->LoadSkill(eSkill11, "Pet Damage Bonus",	100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill12, "Final Life",			2,		10,	PointNext,	true);
	//this->LoadSkill(eSkill13, "Strength",			100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill14, "Defence Rate",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill15, "Fire Damage",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill16, "Energy",				100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill17, "Agility",			100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill18, "Double Damage",		1,		10,	PointNext,	true);
	//this->LoadSkill(eSkill19, "Final SD",			1,		10,	PointNext,	true);
	//this->LoadSkill(eSkill20, "Final Defence",		1,		10,	PointNext,	true);
	//this->LoadSkill(eSkill21, "Zen Drop",			100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill22, "Guild Bonus",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill23, "Reflect Damage",		1,		10,	PointNext,	true);
	//this->LoadSkill(eSkill24, "Exellent Damage Rate",1,		10,	PointNext,	true);
	//this->LoadSkill(eSkill25, "PvP Bonus Plus",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill26, "Min Defence",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill27, "Experience",			2,		10,	PointNext,	true);
	//this->LoadSkill(eSkill28, "Start SD",			100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill29, "Party Bonus",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill30, "Ice Damage",			100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill31, "Distance Attack",	100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill32, "Attack Rate",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill33, "Weapon Bonus",		100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill34, "Exellent Damage",	100,	10,	PointNext,	false);
	//this->LoadSkill(eSkill35, "Critical Damage",	1000,	10,	PointNext,	false);
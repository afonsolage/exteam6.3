...
int CBloodCastle::EnterUserBridge(int iBridgeIndex, int iUserIndex)
{
	...
	for ( int i=0;i<MAX_BLOOD_CASTLE_SUB_BRIDGE;i++)
	{
		...
		{
			if( i > ExConfig.m_iBloodCastleMaxUser)
			{
				break;
			}
		}
...
void CBloodCastle::DropChaosGem(int iIndex) //00552850
{
	...
	////Configs
	//int Ex_BCDropType	= GetPrivateProfileInt("BloodCastle","BCDropType",12,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropID		= GetPrivateProfileInt("BloodCastle","BCDropID",15,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropLevel	= GetPrivateProfileInt("BloodCastle","BCDropLevel",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropSkill	= GetPrivateProfileInt("BloodCastle","BCDropSkill",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropLuck	= GetPrivateProfileInt("BloodCastle","BCDropLuck",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropOpt	= GetPrivateProfileInt("BloodCastle","BCDropOpt",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropExcOpt	= GetPrivateProfileInt("BloodCastle","BCDropExcOpt",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_BCDropAncOpt	= GetPrivateProfileInt("BloodCastle","BCDropAncOpt",0,"..\\Data\\ExData\\Events.ini");



	//Ex_BCDropLuck_DRYNEA
	int Exe1 = 0;
	int Anc1 = 0;

#ifdef BC_LVL_DROP
	//if(g_ExLicense.CheckUser(eExUB::drynea) || g_ExLicense.CheckUser(eExUB::Local2) || g_ExLicense.CheckUser(eExUB::Local))
	//{
	//	switch(gObj[iIndex].MapNumber)
	//	{
	//	case MAP_INDEX_BLOODCASTLE1:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[1] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[1]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[1] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[1] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[1];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[1], ExConfig.Event.Ex_BCDropID_DRYNEA[1]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[1], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[1], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[1], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[1], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE2:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[2] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[2]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[2] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[2] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[2];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[2], ExConfig.Event.Ex_BCDropID_DRYNEA[2]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[2], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[2], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[2], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[2], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE3:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[3] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[3]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[3] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[3] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[3];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[3], ExConfig.Event.Ex_BCDropID_DRYNEA[3]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[3], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[3], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[3], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[3], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE4:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[4] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[4]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[4] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[4] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[4];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[4], ExConfig.Event.Ex_BCDropID_DRYNEA[4]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[4], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[4], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[4], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[4], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE5:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[5] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[5]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[5] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[5] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[5];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[5], ExConfig.Event.Ex_BCDropID_DRYNEA[5]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[5], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[5], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[5], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[5], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE6:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[6] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[6]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[6] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[6] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[6];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[6], ExConfig.Event.Ex_BCDropID_DRYNEA[6]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[6], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[6], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[6], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[6], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE7:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[7] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[7]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[7] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[7] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[7];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[7], ExConfig.Event.Ex_BCDropID_DRYNEA[7]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[7], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[7], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[7], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[7], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE8:
	//		{
	//			if ( ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[8] > 0 )
	//			Exe1 = GenExcOpt(ExConfig.Event.Ex_BCDropExcOpt_DRYNEA[8]);

	//			if ( ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[8] == 5 || ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[8] == 10 )
	//			Anc1 = ExConfig.Event.Ex_BCDropAncOpt_DRYNEA[8];

	//			int iType = ItemGetNumberMake(ExConfig.Event.Ex_BCDropType_DRYNEA[8], ExConfig.Event.Ex_BCDropID_DRYNEA[8]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ExConfig.Event.Ex_BCDropLevel_DRYNEA[8], 0, (BYTE)ExConfig.Event.Ex_BCDropSkill_DRYNEA[8], (BYTE)ExConfig.Event.Ex_BCDropLuck_DRYNEA[8], 
	//			(BYTE)ExConfig.Event.Ex_BCDropOpt_DRYNEA[8], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	}
	//}

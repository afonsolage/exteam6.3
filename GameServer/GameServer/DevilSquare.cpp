...
void CDevilSquare::gObjExpParty(LPOBJ lpObj, LPOBJ lpTargetObj, int AttackDamage, BOOL MSBFlag)
{
	...
	if ( viewplayer > 1 )
	{
		if ( bApplaySetParty != FALSE )
		{
			if ( viewplayer == 3 )
			{
				viewpercent = ExConfig.Event.DSParty3ExpPercent;//230;
			}
			else if ( viewplayer == 4 )
			{
				viewpercent = ExConfig.Event.DSParty4ExpPercent;//270;
			}
			else if ( viewplayer >= 5 )
			{
				viewpercent = ExConfig.Event.DSParty5ExpPercent;//300;
			}
			else
			{
				viewpercent = ExConfig.Event.DSPartyExpPercentOther;//120;
			}
		}
		else
		{
			if ( viewplayer == 2 )
			{
				viewpercent = ExConfig.Event.DSParty2ExpSetPercent;//160;
			}
			else if ( viewplayer == 3 )
			{
				viewpercent = ExConfig.Event.DSParty3ExpSetPercent;//180;
			}
			else if ( viewplayer == 4 )
			{
				viewpercent = ExConfig.Event.DSParty4ExpSetPercent;//200;
			}
			else if ( viewplayer >= 5 )
			{
				viewpercent = ExConfig.Event.DSParty5ExpSetPercent;//220;
			}
			else
			{
				viewpercent = ExConfig.Event.DSParty1ExpSetPercent;//120;
			}
		}

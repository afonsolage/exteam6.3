...
void CObjUseSkill::KnightSkillAddLife(int aIndex, int skill_level) //
{
	...
	////int ExStartPowerHp = GetPrivateProfileInt("DakrKnight","HPStartPower",12,"..\\Data\\ExData\\Skills.ini");
	////int ExVitality = GetPrivateProfileInt("DakrKnight","HPVitality",100,"..\\Data\\ExData\\Skills.ini");
	////int ExEnergy = GetPrivateProfileInt("DakrKnight","HPEnergy",20,"..\\Data\\ExData\\Skills.ini");
	////int ExMaxPowerHp = GetPrivateProfileInt("DakrKnight","HPMaxPower",200,"..\\Data\\ExData\\Skills.ini");
	...
	if(partynum == -1)
	{
		...
		if(g_ExLicense.CheckUser(eExUB::PrideMuLocal) || g_ExLicense.CheckUser(eExUB::PrideMu) || g_ExLicense.CheckUser(eExUB::Local3))
		{
			iaddlife = int(lpObj->MaxLife) * iaddLifepower / 100;
			iaddlife *= ExConfig.PrideMu.Fortitude / 100;
		}
		else
		{
			iaddlife = int(lpObj->MaxLife) * iaddLifepower / 100;
...
void CObjUseSkill::WizardMagicDefense(int aIndex, int aTargetIndex, int skill_level) //004C0560
{
	...
	////int ExMSStartPower = GetPrivateProfileInt("DarkWizard","MSStartPower",10,"..\\Data\\ExData\\Skills.ini");
	////int ExMSAgility = GetPrivateProfileInt("DarkWizard","MSAgility",50,"..\\Data\\ExData\\Skills.ini");
	////int ExMSEnergy = GetPrivateProfileInt("DarkWizard","MSEnergy",200,"..\\Data\\ExData\\Skills.ini");
	////int ExMSMaxPower = GetPrivateProfileInt("DarkWizard","MSMaxPower",50,"..\\Data\\ExData\\Skills.ini");
...
void CObjUseSkill::SkillDefense(int aIndex, int aTargetIndex, int skill_level) //
{
	...
	//	skill_level = 0;
	//}
	////int ExDefenceEnergy = GetPrivateProfileInt("Elf","DefenceEnergy",8,"..\\Data\\ExData\\Skills.ini");
...
void CObjUseSkill::SkillAttack(int aIndex, int aTargetIndex, int skill_level) //
{
	...
	//	skill_level = 0;
	//}
	////int ExAttackEnergy = GetPrivateProfileInt("Elf","AttackEnergy",7,"..\\Data\\ExData\\Skills.ini");
...
void CObjUseSkill::SkillRecallParty(int aIndex, int skill_level) //
{
	...
	//if(!g_ExTeleport.Check(aIndex))
	//{
	//	return;
	//}
#endif
#if(CUSTOM_EX_TELEPORT_EVO)
	//if(!g_ExTeleportEvo.Check(aIndex))
	//{
	//	return;
	//}
#endif
...
BOOL CObjUseSkill::SkillKnightRush(int aIndex, int aTargetIndex, CMagicInf * lpMagic) //
{
	...
	LPOBJ lpObj = &gObj[aIndex];
	//int ExBKCSSKill = GetPrivateProfileInt("CastleSkills","CastleSkillsOnNormal",0,"..\\Data\\ExData\\Skills.ini");
	if(!ExConfig.Character.CastleSiegeSkillEnable)
	{
...
int CObjUseSkill::SkillDamageReflection(int aIndex,int aTargetIndex,CMagicInf * lpMagic) //004C8CF0
{
	...
	////嵌臟嵬債惺僚
	////int ExRefStartPower = GetPrivateProfileInt("Summoner","RefStartPower",30,"..\\Data\\ExData\\Skills.ini");
	////int ExRefEnergy = GetPrivateProfileInt("Summoner","RefEnergy",42,"..\\Data\\ExData\\Skills.ini");
	////int ExRefMaxPower = GetPrivateProfileInt("Summoner","RefMaxPower",50,"..\\Data\\ExData\\Skills.ini");
	////int ExRefStartTime = GetPrivateProfileInt("Summoner","RefStartTime",30,"..\\Data\\ExData\\Skills.ini");
	////int ExRefEneTime = GetPrivateProfileInt("Summoner","RefEneTime",25,"..\\Data\\ExData\\Skills.ini");
...
int CObjUseSkill::SkillBerserker(int aIndex, CMagicInf* lpMagic) //004F74C0
{
	...
	////int ExBerserkerStartTime = GetPrivateProfileInt("Summoner","BerserkerStartTime",30,"..\\Data\\ExData\\Skills.ini");
	////int ExBerserkerEnergyTime = GetPrivateProfileInt("Summoner","BerserkerEnergyTime",20,"..\\Data\\ExData\\Skills.ini");
	////int ExBerserkerMaxTime = GetPrivateProfileInt("Summoner","BerserkerMaxTime",0,"..\\Data\\ExData\\Skills.ini");

	////int ExBerserkerEneIncMana = GetPrivateProfileInt("Summoner","BerserkerEneIncMana",30,"..\\Data\\ExData\\Skills.ini");
	////int ExBerserkerEneDecLife = GetPrivateProfileInt("Summoner","BerserkerEneDecLife",60,"..\\Data\\ExData\\Skills.ini");
	///*
	...
	int iIncMana;
	if (!ExConfig.Character.BerserkAddMana)
	{
		iIncMana	= 0;
	}
	else
...
int CObjUseSkill::SkillExpansionWizardry(int aIndex, int aTargetIndex, CMagicInf *lpMagic) //004F8CF0
{
	...
	//}
	////ExTest
	////int ExWizardryPowerMax = GetPrivateProfileInt("DarkWizard","WizardryPowerMax",20,"..\\Data\\ExData\\Skills.ini");

...
//Season 5 New Box
//extern CItemBagEx * ShiningJewelryCase;	
//extern CItemBagEx * ElegantJewelryCase;	
//extern CItemBagEx * SteelJewelryCase;	
//extern CItemBagEx * OldJewelryCase;	
...
extern int gItemDropLuckRate;
extern int gItemDropSkillRate;
extern int gItemDropOpt4Rate;
extern int gItemDropOpt8Rate;
extern int gItemDropOpt12Rate;
...
extern int ExPartyExpPercentOther;
extern int ExParty2ExpSetPercent;
extern int ExParty3ExpSetPercent;
extern int ExParty4ExpSetPercent;
extern int ExParty5ExpSetPercent;
extern int ExParty1ExpSetPercent;
#if _NEW_PARTY_SYSTEM_ == TRUE
extern int g_MaxPartyMember;
extern int ExParty6ExpPercent;
extern int ExParty7ExpPercent;
extern int ExParty8ExpPercent;
extern int ExParty9ExpPercent;
extern int ExParty10ExpPercent;
extern int ExParty6ExpSetPercent;
extern int ExParty7ExpSetPercent;
extern int ExParty8ExpSetPercent;
extern int ExParty9ExpSetPercent;
extern int ExParty10ExpSetPercent;
#endif
...
extern int	Ex_LifeRate;
extern int	Ex_SoulRate;
extern int	Ex_SoulRateLuck;

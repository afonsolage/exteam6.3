...
enum eSkillType
{
	...
	AT_SKILL_DRAINLIFE = 214,
	AT_SKILL_DAMAGE_REFLECTION = 217,
	AT_SKILL_BERSERKER = 218,
	AT_SKILL_EXPANSION_WIZARDRY = 233,
	AT_SKILL_KILLING_BLOW = 260,
	AT_SKILL_BEAST_UPPERCUT = 261,
	AT_SKILL_CHAIN_DRIVE = 262,
	AT_SKILL_DARK_SIDE = 263,
	AT_SKILL_DRAGON_ROAR = 264,
	AT_SKILL_DRAGON_SLASHER = 265,
	AT_SKILL_IGNORE_DEFENSE = 266,
	AT_SKILL_INCREASE_VIT = 267,
	AT_SKILL_INCREASE_DEFRATE = 268,
	AT_SKILL_CHARGE = 269,

...
void Voter::Init()
{
	...
	this->MMOTOP_BuffTime = GetPrivateProfileInt("ExTeam", "MMOTOP_BuffTime", 0, VOTER_DIR);
	this->MMOTOP_SMSBuffTime = GetPrivateProfileInt("ExTeam", "MMOTOP_SMSBuffTime", 0, VOTER_DIR);
	this->QTOP_BuffTime = GetPrivateProfileInt("ExTeam", "QTOP_BuffTime", 0, VOTER_DIR);
	this->QTOP_SMSBuffTime = GetPrivateProfileInt("ExTeam", "QTOP_SMSBuffTime", 0, VOTER_DIR);
}

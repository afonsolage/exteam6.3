...
void CIllusionTempleProcess::ProcState_Closed(int iTick) 
{
	...
	if(this->m_iLeftMinutesBeforeOpen <= 0)
	{
		if(this->m_iEventBattleTimer <= 0)
		{
			...
			//int Ex_IllusionTemplPlaerMin = GetPrivateProfileInt("IllusionTemple","ItMinPlayers",4,"..\\Data\\ExData\\Events.ini");
...
void CIllusionTempleProcess::DropRewardItem(int aIndex)
{
	...
	int loc2 = aIndex;
	//Configs
	//int Ex_ItDropType	= GetPrivateProfileInt("IllusionTemple","ItDropType",12,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropID		= GetPrivateProfileInt("IllusionTemple","ItDropID",15,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropLevel	= GetPrivateProfileInt("IllusionTemple","ItDropLevel",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropSkill	= GetPrivateProfileInt("IllusionTemple","ItDropSkill",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropLuck	= GetPrivateProfileInt("IllusionTemple","ItDropLuck",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropOpt	= GetPrivateProfileInt("IllusionTemple","ItDropOpt",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropExcOpt	= GetPrivateProfileInt("IllusionTemple","ItDropExcOpt",0,"..\\Data\\ExData\\Events.ini");
	//int Ex_ItDropAncOpt	= GetPrivateProfileInt("IllusionTemple","ItDropAncOpt",0,"..\\Data\\ExData\\Events.ini");

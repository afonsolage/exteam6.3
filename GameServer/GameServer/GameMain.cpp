...
//Season 5 New Box
//CItemBagEx * ShiningJewelryCase;
//CItemBagEx * ElegantJewelryCase;
//CItemBagEx * SteelJewelryCase;
//CItemBagEx * OldJewelryCase;
...
int  gItemDropLuckRate = 4;
int  gItemDropSkillRate = 6;
int  gItemDropOpt4Rate = 12;
int  gItemDropOpt8Rate = 8;
int  gItemDropOpt12Rate = 4;
...
int ExParty6ExpPercent;
int ExParty7ExpPercent;
int ExParty8ExpPercent;
int ExParty9ExpPercent;
int ExParty10ExpPercent;
int ExParty6ExpSetPercent;
int ExParty7ExpSetPercent;
int ExParty8ExpSetPercent;
int ExParty9ExpSetPercent;
int ExParty10ExpSetPercent;
#endif
...
void GameMainInit(HWND hWnd)
{
	...
	char MapAttrName[MAX_NUMBER_MAP][36] =
	{
		...
		".\\Terrains\\Terrain84.att", //
		".\\Terrains\\Terrain85.att", //
		".\\Terrains\\Terrain86.att", //
		".\\Terrains\\Terrain87.att", //
		".\\Terrains\\Terrain88.att", //
		".\\Terrains\\Terrain89.att", //
		".\\Terrains\\Terrain90.att", //
...
void ReadCommonServerInfo()
{
	...
	GetPrivateProfileString("GameServerInfo", "ItemDropLuckRate", "4", szTemp, 5, gDirPath.GetNewPath("commonserver.cfg"));
	gItemDropLuckRate = atoi(szTemp);
	GetPrivateProfileString("GameServerInfo", "ItemDropSkillRate", "6", szTemp, 5, gDirPath.GetNewPath("commonserver.cfg"));
	gItemDropSkillRate = atoi(szTemp);
	GetPrivateProfileString("GameServerInfo", "ItemDropOpt4Rate", "12", szTemp, 5, gDirPath.GetNewPath("commonserver.cfg"));
	gItemDropOpt4Rate = atoi(szTemp);
	GetPrivateProfileString("GameServerInfo", "ItemDropOpt8Rate", "8", szTemp, 5, gDirPath.GetNewPath("commonserver.cfg"));
	gItemDropOpt8Rate = atoi(szTemp);
	GetPrivateProfileString("GameServerInfo", "ItemDropOpt12Rate", "4", szTemp, 5, gDirPath.GetNewPath("commonserver.cfg"));
	gItemDropOpt12Rate = atoi(szTemp);
	...
	wsprintf(cGsVersion, "%s", exVERSION);

	SYSTEMTIME tmNowDate;
	GetLocalTime(&tmNowDate);

	wsprintf(szTemp, "%s :: ExTeam :: 2012-%d :: %s :: Version: %c.%c%c.%c%c :: Serial: %s", 
	...
	ExPartyExpPercentOther = GetPrivateProfileInt("GameServerInfo","PartyExpPercentOther",120,gDirPath.GetNewPath("commonserver.cfg"));
	ExParty2ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party2ExpSetPercent",160,gDirPath.GetNewPath("commonserver.cfg"));
	ExParty3ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party3ExpSetPercent",180,gDirPath.GetNewPath("commonserver.cfg"));
	ExParty4ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party4ExpSetPercent",200,gDirPath.GetNewPath("commonserver.cfg"));
	ExParty5ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party5ExpSetPercent",220,gDirPath.GetNewPath("commonserver.cfg"));
	ExParty1ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party1ExpSetPercent",150,gDirPath.GetNewPath("commonserver.cfg"));


#if _NEW_PARTY_SYSTEM_ == TRUE
	g_MaxPartyMember = 5;
	if(g_ExLicense.user.PartySystem)
	{
		g_MaxPartyMember = GetPrivateProfileInt("GameServerInfo","MaxPartyMember",10,gDirPath.GetNewPath("commonserver.cfg"));

		ExParty6ExpPercent = GetPrivateProfileInt("GameServerInfo","Party6ExpPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty7ExpPercent = GetPrivateProfileInt("GameServerInfo","Party7ExpPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty8ExpPercent = GetPrivateProfileInt("GameServerInfo","Party8ExpPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty9ExpPercent = GetPrivateProfileInt("GameServerInfo","Party9ExpPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty10ExpPercent = GetPrivateProfileInt("GameServerInfo","Party10ExpPercent",300,gDirPath.GetNewPath("commonserver.cfg"));

		ExParty6ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party6ExpSetPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty7ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party7ExpSetPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty8ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party8ExpSetPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty9ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party9ExpSetPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
		ExParty10ExpSetPercent = GetPrivateProfileInt("GameServerInfo","Party10ExpSetPercent",300,gDirPath.GetNewPath("commonserver.cfg"));
	}
#endif
	...
	Ex_ItemsDurationTime = GetPrivateProfileInt("GameServerInfo","ItemsDurationTime",120,gDirPath.GetNewPath("commonserver.cfg"));

	Ex_LifeRate = GetPrivateProfileInt("GameServerInfo","LifeRate",50,gDirPath.GetNewPath("commonserver.cfg"));
	Ex_SoulRate = GetPrivateProfileInt("GameServerInfo","SoulRate",50,gDirPath.GetNewPath("commonserver.cfg"));
	Ex_SoulRateLuck = GetPrivateProfileInt("GameServerInfo","SoulRateLuck",20,gDirPath.GetNewPath("commonserver.cfg"));
...
void LoadItemBag() //0053E2F0
{
	...
	SilverChestItemBag = new CItemBagEx; 
	if ( SilverChestItemBag == NULL )
	{
		// Memory allocation error
		MsgBox("CItemBag %s", lMsg.Get(MSGGET(0, 110)));
	...
	GoldenChestItemBag = new CItemBagEx; 
	if ( GoldenChestItemBag == NULL )
	{
		// Memory allocation error
		MsgBox("CItemBag %s", lMsg.Get(MSGGET(0, 110)));
...
//CItemBagEx * OldJewelryCase;
	...
	//ShiningJewelryCase = new CItemBagEx; 
	...
	//ElegantJewelryCase = new CItemBagEx; 
	...
	//SteelJewelryCase = new CItemBagEx; 
		...
		case 5: //Ring Event
			{
				...
				#if(GS_CASTLE==1 || CS_SERVER)//Crazzy-fix

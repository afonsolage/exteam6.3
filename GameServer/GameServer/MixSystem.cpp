...
int CMixSystem::ChaosBoxMix(LPOBJ lpObj, int & Result2, int & Result3)
{
	...
	if(WingCharmItemNum > -1) //season4.5 add-on
	{
		...
		case 85:
			...
			break;
		case 86:
			if(ExConfig.ExCustom.SwitchChar == 2)
			{
				Result3 = 0;
			}
			else
...
BOOL CMixSystem::PlusItemLevelChaosMix(LPOBJ lpObj, int mixType)
{
	...
	if ( lpObj->pChaosBox[PlusItemPos].m_Level == 9 )
	{
		...
		{
			//int ExMixNormal10SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal10SuccessRate",60,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixNormal10SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ExMix380AncExc10SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc10SuccessRate",50,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMix380AncExc10SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ExMixSocket10SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket10SuccessRate",40,"..\\Data\\ExData\\CommonServer.ini");
	...
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 10) //season4 changed
	{
		if(btMixLevel == 1) //season4.5 add-on
		{
			//int ExMixNormal11SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal11SuccessRate",60,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixNormal11SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ExMix380AncExc11SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc11SuccessRate",50,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMix380AncExc11SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ExMixSocket11SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket11SuccessRate",40,"..\\Data\\ExData\\CommonServer.ini");
	...
	else if (lpObj->pChaosBox[PlusItemPos].m_Level == 11) //season4 changed
	{
		if(btMixLevel == 1) //season4.5 add-on
		{
			//int ExMixNormal12SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal12SuccessRate",60,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixNormal12SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ExMix380AncExc12SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc12SuccessRate",50,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMix380AncExc12SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ExMixSocket12SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket12SuccessRate",40,"..\\Data\\ExData\\CommonServer.ini");
	...
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 12) //season4 changed
	{
		if(btMixLevel == 1) //season4.5 add-on
		{
			//int ExMixNormal13SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal13SuccessRate",55,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixNormal13SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ExMix380AncExc13SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc13SuccessRate",50,"..\\Data\\ExData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMix380AncExc13SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ExMixSocket13SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket13SuccessRate",35,"..\\Data\\ExData\\CommonServer.ini");
	...
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 13) //Season 5 +15 Items
	{
		if(btMixLevel == 1) 
		{
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixNormal14SuccessRate;
		}
		else if(btMixLevel == 2)
		{
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMix380AncExc14SuccessRate;
		}
		else if(btMixLevel == 3) 
		{
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixSocket14SuccessRate;
		}
	}
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 14) //Season 5 +15 Items
	{
		if(btMixLevel == 1) 
		{
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixNormal15SuccessRate;
		}
		else if(btMixLevel == 2)
		{
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMix380AncExc15SuccessRate;
		}
		else if(btMixLevel == 3) 
		{
			lpObj->ChaosSuccessRate = ExConfig.CommonServer.ExMixSocket15SuccessRate;
		}
	}
	else
	{
	...
	{
		//int ExMixLuckOptRateAdd = GetPrivateProfileInt("ChaosMix","MixLuckOptRateAdd",20,"..\\Data\\ExData\\CommonServer.ini");
		lpObj->ChaosSuccessRate += ExConfig.CommonServer.ExMixLuckOptRateAdd;
	}

	if ( lpObj->ChaosSuccessRate > ExConfig.CommonServer.ExMixMaxSuccessRate )
	{
		//int ExMixMaxSuccessRate = GetPrivateProfileInt("ChaosMix","MixMaxSuccessRate",75,"..\\Data\\ExData\\CommonServer.ini");
...
BOOL CMixSystem::PegasiaChaosMix(LPOBJ lpObj)
{
	...
	//int ExDinorantMixRate = GetPrivateProfileInt("ChaosMix","DinorantMixRate",70,"..\\Data\\ExData\\CommonServer.ini");
...
BOOL CMixSystem::WingChaosMix(LPOBJ lpObj)
{
	...
	//int ExWing2MaxSuccessRate = GetPrivateProfileInt("ChaosMix","Wing2MaxSuccessRate",90,"..\\Data\\ExData\\CommonServer.ini");
	...
	if ( (rand()%100) < lpObj->ChaosSuccessRate )
	{
		...
		if ( iSleeveOfLord != 0 )
		{
			...
			if(ExConfig.ExCustom.SwitchChar == 1 || ExConfig.ExCustom.SwitchChar == 2)
			{
				iItemType		= 13;
				iItemSubType	= 30;
			}
		...
		else
		{
			...
			if(iRand == 4 && ExConfig.ExCustom.SwitchChar != 2)//Conflict //See DangeR
			{
				iItemSubType = 42;
			}
			else
...
void CMixSystem::DarkHorseChaosMix(LPOBJ lpObj)
{
	...
	//int ExDarkHorseMixSuccessRate = GetPrivateProfileInt("ChaosMix","DarkHorseMixSuccessRate",60,"..\\Data\\ExData\\CommonServer.ini");
...
void CMixSystem::DarkSpiritChaosMix(LPOBJ lpObj)
{
	...
	//int ExDarkSpiritMixSuccessRate = GetPrivateProfileInt("ChaosMix","DarkSpiritMixSuccessRate",60,"..\\Data\\ExData\\CommonServer.ini");
...
void CMixSystem::ThirdWingMix1(LPOBJ lpObj)
{
	...
	//int ExFeatherofCondorMixMaxPercent = GetPrivateProfileInt("ChaosMix","FeatherofCondorMixMaxPercent",60,"..\\Data\\ExData\\CommonServer.ini");
...
{	
	...
	//int ExWingLv3MixMaxPercent = GetPrivateProfileInt("ChaosMix","WingLv3MixMaxPercent",40,"..\\Data\\ExData\\CommonServer.ini");
	...
	if ( (rand()%100) < lpObj->ChaosSuccessRate )
	{
		...
		if(ExConfig.ExCustom.SwitchChar == 1)
		{
			CharItemCount = 6;
		}
		else if(ExConfig.ExCustom.SwitchChar == 2)
		{
			CharItemCount = 5;
		}

...
#ifdef HP_CONFIG
#include "..\GameServer\ExLicense.h"
...
void classdef::Init()
{
	...
	this->SetCharacter( CLASS_MAGUMSA, 26, 26, 26, 26, 110.0, 60.0, 1.0, 1.0, 3.0, 2.0, 0);
...
void classdef::SetCharacter(int Class, int Str, int Dex, int Vit, int Energy, float Life, float Mana, float LevelLife, float LevelMana, float VitalityToLife, float EnergyToMana, int Leadership)
{
	...
	if(g_ExLicense.CheckUser(eExUB::PrideMuLocal) || g_ExLicense.CheckUser(eExUB::PrideMu))
	{
		...
		{
			case CLASS_WIZARD:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeSM / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeSM / 10.0;
				break;
			case CLASS_KNIGHT:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeDK / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeDK / 10.0;
				break;
			case CLASS_ELF:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeELF / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeELF / 10.0;
				break;
			case CLASS_MAGUMSA:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeMG / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeMG / 10.0;
				break;
			case CLASS_DARKLORD:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeDL / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeDL / 10.0;
				break;
			case CLASS_SUMMONER:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeSUM / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeSUM / 10.0;
				break;
			case CLASS_MONK:
				this->DefClass[Class].LevelLife = (float)ExConfig.PrideMu.LevelLifeRF / 10.0;
				this->DefClass[Class].VitalityToLife = (float)ExConfig.PrideMu.VitalityToLifeRF / 10.0;
				break;
		}
	}
#endif

...
{
	pLoadImage("Custom\\Interface\\pm_flag.tga", ex_PM_FLAGNEW_LEADER, 0x2601, 0x2900, 1, 0);
}
#endif
...
void NewParty::Load()
{
	...
	TestOPEx((LPVOID)0x0078F13A, &AdressNewParty, PUSH_OFFSET);	//прием в парти
	...
	TestOPEx((LPVOID)0x0078F124, &AddressPartyMemberCount, 0x83, 0x3D);	//Принимает в пт любой фикс

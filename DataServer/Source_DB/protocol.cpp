...
//#endif
...
#if(EX_LICENSE==TRUE)
			case 0x00:
				g_ExLicense.GDLicenseUser((PMSG_LICENSE_DATA*)aRecv);
				break;
#endif
	...
	case 0xEE:
		{
			PMSG_DEFAULT2* lpDef = (PMSG_DEFAULT2*)aRecv;
			g_ExWebManager.Protocol(lpDef->subcode, aRecv, aIndex);
		}
		break;
	case 0xEF:
		{
...
void GJPSetCharacterInfo(LPSDHP_DBCHAR_INFOSAVE lpMsg, short aIndex)
{
	...
	CharObject.ExFreePoints = lpMsg->ExFreePoints;
	CharObject.Reset = lpMsg->Reset;
	CharObject.GReset = lpMsg->GReset;
	CharObject.ExQuestNum = lpMsg->ExQuestNum;
	CharObject.ExQuestKill = lpMsg->ExQuestKill; 
...
void GDReqWcoinInfo(LPREQ_WCOIN_INFO lpMsg, int aIndex)	//old exteam season 4 
{

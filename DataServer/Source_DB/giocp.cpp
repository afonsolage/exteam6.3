...
DWORD WINAPI IocpServerWorker(LPVOID p)
{
    ...
    { 
		...
		#if(THREAD_FIFTH)
		ThreadHandle = CreateThread(NULL, 0, ServerRecvWorkerThreadFifth, (LPVOID)NULL, 0, &ThreadID); //exteam multi emulator add-on
		if (ThreadHandle == NULL)
		{
		...
		ThreadHandle = CreateThread(NULL, 0, ServerRecvWorkerThreadSix, (LPVOID)NULL, 0, &ThreadID); //exteam multi emulator add-on
		if (ThreadHandle == NULL)
		{
